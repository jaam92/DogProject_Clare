...
indivsTM = read.table(file = "/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/IndivFiles/TM_indivList_downsample_N9.txt")
...
write.table(summaryInfo, file = "/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/pairwiseFst/FixedSites_EWvsTM_N9.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)

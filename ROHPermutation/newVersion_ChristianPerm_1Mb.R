...
#source(file = "generateRdataFile4Permuation_1Mb.R")

#Load data
load(file="/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/ROHPermutation/all_SNP_1MbROH_annotation_DogProjectClareDec2018.Rdata")
...
save(file="permutation_results_allCanids_1MbROH.Rdata", pval_group, X_squared_group, empirical_table_group, ratios_group)



#Plots

load(file="permutation_results_allCanids_1MbROH.Rdata")
...
write.csv(ratios_group_df, row.names = FALSE, file = "ratios_pvalues_pergroup_1MbROH.csv")

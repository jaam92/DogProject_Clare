...
#python addPositionAttributes_chr18to38.py ${inputAnnotFile} 2 ${outputFile1} ranges ${ROHrange1} withinROH_10Kb ${ROHrange2} withinROH_1Mb  

#Step 2: Add GERP Score
python addPositionAttributes_chr18to38.py ${outputFile1} 2 ${outputFile2} positionAnnotation ${GERPscores} GERPScore

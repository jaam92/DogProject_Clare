...
setwd("/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/ROHPermutation/PermutationsVEP")
...
# Save all data
#save(snp_data, ROH_data, annotation_data, group, file="all_SNP_10KbROH_annotation_DogProjectClareDec2018.Rdata")

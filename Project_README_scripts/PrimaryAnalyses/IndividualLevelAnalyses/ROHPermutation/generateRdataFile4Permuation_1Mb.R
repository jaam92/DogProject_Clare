...
#Empty data frames for annotatin, snp, and ROH data
...
#plot specifications
jpeg(file = "ROH_data_1Mb.jpg", width=1200*3, height=500*11/2, pointsize = 16)
par(mfrow=c(8,3))
par(mar=c(5,7,2,2)+0.1)

#Grab files 
fn = dir(pattern = "PermFormat_OneMbROH_", full.names = TRUE)
fn = str_sort(fn, numeric = TRUE) 
...
# Save all data
save(snp_data, ROH_data, annotation_data, group, file="all_SNP_1MbROH_annotation_DogProjectClareDec2018.Rdata")

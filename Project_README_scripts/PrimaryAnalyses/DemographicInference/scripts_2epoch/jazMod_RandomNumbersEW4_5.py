...
#Output Files
RandomNumbersFile = "/u/flashscratch/j/jmooney3/SimulationsAndParamsABC/RandomNumbersEWsamps_" + str(Number) + ".txt"
...
#sample uniform from 11k to 100K
NeTwo = random.random()* 89000; ##100K-11k
NeTwo = int( NeTwo + 11000 + 0.5);

#sample uniform from 10 to 6000
Time = random.random()*5990 ; #6000-10

...
#source(file = "generateRdataFile4Permuation.R")

#Load data
load(file="/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/ROHPermutation/all_SNP_10KbROH_annotation_DogProjectClareDec2018.Rdata")
...
if(FALSE) {
  jpeg("permutation_10Kb.jpg", width=1200, height=1500/4*5)
...
save(file="permutation_results_allCanids_10KbROH.Rdata", pval_group, X_squared_group, empirical_table_group, ratios_group)



#Plots

load(file="permutation_results_allCanids_10KbROH.Rdata")
...
write.csv(ratios_group_df, row.names = FALSE, file = "ratios_pvalues_pergroup_10KbROH.csv")

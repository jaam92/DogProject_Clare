...
df = fread("/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/RunABC/InputData/NeutralRegionsEW/EWSamps_allChroms_NeutralRegions_het_1000win_1000step_Header.txt")
...
write.table(df_SummaryStats, file = "/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/RunABC/InputData/EWSamps_allChroms_NeutralRegions_het_1000win_1000step_ABCinputFile.txt",sep = "\t", row.names = F, col.names = T, quote = F)

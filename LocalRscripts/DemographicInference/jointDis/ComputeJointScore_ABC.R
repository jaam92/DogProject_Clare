...
option_list <- list( 
  ...
  make_option(c("--outFilePath"), type="character", default="/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/RunABC/testJointDisScripts",
...
#Input parameters
#####Uncomment for running on cluster#######

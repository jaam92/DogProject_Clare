...
#read file in
pairwiseFst = read_delim("~/Documents/DogProject_Clare/LocalRscripts/OutliersFst/EW_vs_TM_allSites_rmNAN.weir.fst", delim = "\t") %>%
  mutate(POS_END = POS,
...
#Read file in 
TM_PI = read_delim("~/Documents/DogProject_Clare/LocalRscripts/OutliersFst/TM_allSites.sites.pi", delim = "\t") %>%

...
setwd("/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/ComputeG12/RunAnalyses")

#Step 1 is to generate the haplotype files
#Use default from nandita
fnames = dir(path = "/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/ComputeG12", pattern = "\\inputG12haps.txt$")
...
for (i in seq_along(fnames)){
  ...
  pythonInputs = glue('
                      /u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/ComputeG12/{inputFile} {numSamps} -o output_{inputFile} -w 50 -j 10 -d 0
                      ')
...
hapFiles = dir(path = "/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/ComputeG12/RunAnalyses/", pattern = "^output\\w*\\.txt$")

for (j in seq_along(hapFiles)){
  inputFile2 = hapFiles[j]
  
  pythonInputs2 = glue('
                      /u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/ComputeG12/RunAnalyses/{inputFile2} -o Peaks_{inputFile2} -t 0.02 
                      ')

...
for line in f:
	...
	if ( Reps > 0 ): #skip header line
		...
		HetCol = Split[CallableSitesEmpirical+3]
...
for line in k:
	...
	if BinomialFlag == 1:
		...
		SimHeterozygotes.append(int(TLine) + Errors)
	else:
		SimHeterozygotes.append(int(TLine))	
...
for i in range(0, 1000): #Maximum amount of hets is 1000 since windows are 1Kb
	CountsSim.append(0)
	CountsData.append(0)

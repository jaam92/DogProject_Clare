...
#sample uniform from 500 to 10000
NeCurr = random.random()* 9500; #10K-500 
NeCurr = int( NeCurr + 500 + 0.5); 

#sample uniform from 11k to 40K
NeTwo = random.random()* 29000; ##40K-11k
NeTwo = int( NeTwo + 11000 + 0.5);

#sample uniform from 500 to 3000
Time = random.random()*2500 ; #3000-500

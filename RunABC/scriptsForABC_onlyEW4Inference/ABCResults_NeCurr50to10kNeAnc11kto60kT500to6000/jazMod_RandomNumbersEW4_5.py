...
#sample uniform from 50 to 10000
NeCurr = random.random()* 9550; #10K-50 
NeCurr = int( NeCurr + 50 + 0.5); 

#sample uniform from 11k to 60K
NeTwo = random.random()* 49000; ##60K-11k
NeTwo = int( NeTwo + 11000 + 0.5);

#sample uniform from 500 to 6000
Time = random.random()*5500 ; #6000-500
Time = int( Time + 500 + 0.5 );

...
python jazMod_RandomNumbersEW4_3epoch.py $SGE_TASK_ID ../InputData/EWSamps_allChroms_NeutralRegions_het_1000win_1000step_ABCinputFile.txt $RandomNumber 200

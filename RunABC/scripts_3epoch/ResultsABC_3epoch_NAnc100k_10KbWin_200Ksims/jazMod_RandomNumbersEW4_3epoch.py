...
#Output Files
RandomNumbersFile = "/u/flashscratch/c/cmarsden/SimulationsAndParamsABC_3epoch/RandomNumbersEWsamps_" + str(Number) + ".txt"
ParamsFile = "/u/flashscratch/c/cmarsden/SimulationsAndParamsABC_3epoch/OutputParams" + str(Number) + ".txt"
...
#Sample uniform from 1500 to 10K
TimeTwo = random.random() * 8500 ; #10K-1500
TimeTwo = int( TimeTwo + 1500 + 0.5 );

#Sample uniform from 40K to 100K
NeThree = random.random()* 60000; #100K-40K

...
snpEff = read.delim("anns_snpEff_cannonicalOnly_reformat.txt")
VEP = read.delim("/u/home/j/jmooney3/klohmueldata/jazlyn_data/DogProject_Clare/VEP/parseVEP/FinalAnnot_VEPSIFTSnpEff_allChroms.txt")
